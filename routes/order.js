...
const { create, listOrders, getStatus, updateStatus, orderById, Statistical } = require("../controllers/order");
...
// router.post('/statictical/:userId',requireSignin, isAdmin, Statistical)
